...
sudo mkdir /spark-home/hadoop-native
cd /tmp
...
sudo mv hadoop-dist/target/hadoop-2.4.1/lib/native/* /spark-home/hadoop-native

# Install Snappy lib (for Hadoop)
yum install -y snappy
ln -sf /usr/lib64/libsnappy.so.1 /spark-home/hadoop-native/.
