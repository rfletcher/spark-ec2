...
case "$HADOOP_MAJOR_VERSION" in
  1)
    ...
    sed -i 's/-jvm server/-server/g' /spark/ephemeral-hdfs/bin/hadoop
    cp /spark/hadoop-native/* /spark/ephemeral-hdfs/lib/native/
    ;;
  2) 
    ...
    rm -rf /spark/ephemeral-hdfs/etc/hadoop/
    ln -s /spark/ephemeral-hdfs/conf /spark/ephemeral-hdfs/etc/hadoop
    cp /spark/hadoop-native/* /spark/ephemeral-hdfs/lib/native/
    ;;
  yarn)
...
/spark/spark-ec2/copy-dir /spark/ephemeral-hdfs
