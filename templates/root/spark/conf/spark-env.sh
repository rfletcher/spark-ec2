...
export HADOOP_HOME="/spark-home/ephemeral-hdfs"
export SPARK_MASTER_IP={{active_master}}
export MASTER=`cat /spark-home/spark-ec2/cluster-url`

export SPARK_SUBMIT_LIBRARY_PATH="$SPARK_SUBMIT_LIBRARY_PATH:/spark-home/ephemeral-hdfs/lib/native/"
export SPARK_SUBMIT_CLASSPATH="$SPARK_CLASSPATH:$SPARK_SUBMIT_CLASSPATH:/spark-home/ephemeral-hdfs/conf"
