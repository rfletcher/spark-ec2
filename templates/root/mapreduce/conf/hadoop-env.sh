...
# NOTE: Set this to /spark/mapreduce so that start-mapred.sh works correctly
export HADOOP_HOME="/spark/mapreduce"
export HADOOP_MAPREDUCE_HOME="/spark/mapreduce"
